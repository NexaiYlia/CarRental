...
public class LoggingAspect {
    ...
    @Pointcut("within(com.academy.car_rental..*)")
    ...
    @Pointcut("within(com.academy.car_rental.service..*)")
    ...
    @Pointcut("within(com.academy.car_rental.controller.*)")
    ...
    @Pointcut("within(com.academy.car_rental.controller.ProjectErrorController)")
